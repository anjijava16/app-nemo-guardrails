...
HR Policy Assistant powered by NVIDIA NeMo Guardrails, FAISS RAG, Streamlit, and Groq.

Repository: https://github.com/anjijava16/app-nemo-guardrails.git
...
**Live demo → [app-nemo-guardrails.streamlit.app](https://app-nemo-guardrails.streamlit.app/)**
...
```bash
# Clone
git clone https://github.com/anjijava16/app-nemo-guardrails.git
cd app-nemo-guardrails
